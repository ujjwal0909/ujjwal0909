...
<details open>
<summary><b>🐍 Languages & ML core</b> <i>(click to collapse)</i></summary>
<br>
...
<!-- Snake animation — requires the GitHub Action below to be set up.
     See the "How to enable the snake" section at the bottom of this file. -->
...
1. In this repo (ujjwal0909/ujjwal0909), create a folder:
      .github/workflows/
     ...
     generate:
       ...
       steps:
         - uses: Platane/snk/svg-only@v3
           with:
             github_user_name: ujjwal0909
             outputs: |
               dist/github-contribution-grid-snake-dark.svg?palette=github-dark&color_snake=#D4FF3A&color_dots=#1e1e2e,#2d4a1f,#4a7d2f,#7fb83d,#D4FF3A
...
4. Commit the file. Then go to the "Actions" tab of this repo and click
